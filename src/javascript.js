...
function makeApiCall(event) {
  ...
  let prompt = `Write a quote about ${topic.value}. It should not be longer than four lines. Write the german translation after a big paragraph below the english one`;
  let context =
